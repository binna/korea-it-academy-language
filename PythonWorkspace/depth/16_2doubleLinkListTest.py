# DoubleLinkedList 에 저장할 데이터를 기억하는 클래스
class Node:
...
class DoubleLinkedList:
    ...
    def listPrint(self):
        node = self.head
        if node:
            print(self.count, "개의 데이터가 DoubleLinkedList 에 저장되어 있습니다.")
            for i in range(self.count - 1):
                print(node.data, end = " ")
                node = node.next
            print(node.data)
        else:
            print("DoubleLinkedList 에 저장된 데이터가 없습니다.")
    ...
    def remove(self, data):
        ...
        if node is not None:
            ...
            while node is not None:
                ...
                node = node.next
            if node == None:
                print("DoubleLinkedList 에 삭제할 데이터가 없습니다.")
                return
            prev.next = node.next
            ...
            print("DoubleLinkedList 가 비어있습니다.")
